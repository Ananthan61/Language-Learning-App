...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <div class="info">
         ...
         <p><i class="fa fa-thumbs-up"></i><span><?= $total_likes; ?>ThumbsUp</span></p>
      </div>
      <div class="tutor">
      ...
      <form action="" method="post" class="flex">
         ...
         ?>
         <button type="submit" name="like_content"><i class="fa fa-thumbs-up"></i><span>liked</span></button>
         <?php
         }else{
         ?>
         <button type="submit" name="like_content"><i class="fa fa-thumbs-upogoe"></i><span>like</span></button>
         <?php
            }
         ?>
      </form>
